...
- how do you get all six dragons in I Ching? there are two ways:
  - (1) sample Hexagram 1 with no changing lines
    - `(5/16)^6 = (15625/16777216) = (0.000931322574615)`
  - (2) or sample Hexagram 2 with all changing lines (1/16))
    - `(1/16)ˆ6 = (1/16777216) = `
- since the endgame of the Chrono Cross plot is about conquering those
  ...
  - Three Dragons in "another world"
    - #4 Fire Dragon
    - #5 Black Dragon (misleading)
    - #6 Sky Dragon

- {Spoiler: Harle}, a seventh pseudo-dragon-god is available as a
  playable character. Tsukuyomi (月読) is the character's Japanese
  name, which is Shinto's God of the Moon. Therefore, there is a
  complement to this God

- the likelihood of drawing the iching reading is *exceedingly*
  rare. a real challenge: `1 in 16,777,216` yarrow stick readings
  should ever give this reading. You're more likely to bridge into an
  parallel universe and defeat six dragon gods.
