...
Glucose is made of six carbons, six oxygens and twelve
hydrogens. Every glucose molecule is distinct, but for any collection
of these 24 atoms that are close enough, we can measure their
similarity or distance from an idealized glucose conformation. Still,
even though each glucose molecule might have idiosyncratic patterns of
vibration subtly influencing their transitions between conformations,
we still consider the six-carbon ring a glucose molecule, whatever
non-linear transient physical deformation it might be in.
